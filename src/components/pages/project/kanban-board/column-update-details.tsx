...
type KanbanColumnUpdateDetailsProps<T extends KanbanColumnFields> = {
  control: ReturnType<typeof useForm<T>>["control"];
};

export function KanbanColumnUpdateDetails<T extends KanbanColumnFields>({
  control,
}: KanbanColumnUpdateDetailsProps<T>) {
  return (
    <>
      <FormField
        control={control}
