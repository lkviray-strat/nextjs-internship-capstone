...
import type { UpdateTaskRequestInput, User } from "@/src/types";
...
type TaskUpdateSearchProps = {
  field: UseControllerReturn<UpdateTaskRequestInput, "assigneeId">["field"];
};
...
export function TaskUpdateSearch({ field }: TaskUpdateSearchProps) {
  const { user } = useUser();
